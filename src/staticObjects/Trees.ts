...
export const trees: TreeConfig[] = [
  {
    ...
    surfaceType: [SurfaceType.Hill, SurfaceType.Rock],
  ...
  {
    name: 'PineTree_Snow_1',
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Mountain, SurfaceType.MountainPeak],
    path: './resources/pineTree/PineTree_Snow_1.fbx',
    collisionUnits: [
      {
        size: new Vector3(10, 55, 10),
        offset: new Vector3(0, -5, 0),
  ...
  {
    name: 'PineTree_Snow_2',
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Mountain, SurfaceType.MountainPeak],
    path: './resources/pineTree/PineTree_Snow_2.fbx',
    collisionUnits: [
      {
        size: new Vector3(10, 55, 10),
        offset: new Vector3(0, -5, 0),
  ...
  {
    name: 'PineTree_Snow_3',
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Mountain, SurfaceType.MountainPeak],
    path: './resources/pineTree/PineTree_Snow_3.fbx',
    collisionUnits: [
      {
        size: new Vector3(9, 42, 9),
        offset: new Vector3(0, -5, 0),
  ...
  {
    name: 'PineTree_Snow_4',
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Mountain, SurfaceType.MountainPeak],
    path: './resources/pineTree/PineTree_Snow_4.fbx',
    collisionUnits: [
      {
        size: new Vector3(9, 35, 10),
        offset: new Vector3(0, -5, 2),
  ...
  {
    name: 'PineTree_Snow_5',
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Mountain, SurfaceType.MountainPeak],
    path: './resources/pineTree/PineTree_Snow_5.fbx',
    collisionUnits: [
      {
        size: new Vector3(8, 67, 8),
        offset: new Vector3(-1, -5, 0),
  ...
  },
  {
    ...
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Seaside, SurfaceType.Hill],
  ...
  },
  {
    name: 'Willow_1',
    modelType: ModelType.FBX,
    surfaceType: [SurfaceType.Seaside, SurfaceType.Beach],
